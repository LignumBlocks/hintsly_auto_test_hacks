...
module ReportGenerator
  ...
  def self.generate_summary_report(comparison_results, general_comparison, statistics, channel_id)
    general_report = generate_general_report(comparison_results, general_comparison, statistics, channel_id)
  ...
  def self.generate_markdown_report(comparison_results, general_comparison, statistics, channel_id)
    general_report = generate_general_report(comparison_results, general_comparison, statistics, channel_id)
  ...
  def self.generate_general_report(comparison_results, general_comparison, statistics, channel_id)
    report_content = "# Analysis of the Test\n\n"

    # Add statistics
    report_content += "## Statistics:\n"
    report_content += "- Total videos in test: #{statistics[:total_hacks]}\n"
    ...
    report_content += "- Total Hacks Compared: #{comparison_results.keys.size}\n"
